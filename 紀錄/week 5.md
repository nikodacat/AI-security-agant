...
...可以產生所有的建議行動<br>
其實差不多可以收尾了<br>
目前的這套流程，能抓到CVE漏洞，安全設定問題，組合/有條件的漏洞也都能檢測出來，然後再把旁邊的cve scanner接上線增加準度就可以了。<br>

接上來後再跑一遍<br>
<img width="2415" height="1004" alt="image" src="https://github.com/user-attachments/assets/f957ac2e-9154-45d1-91f7-702817427388" />
...
## 1.用VM來進行固定環境測試<br>
實際拿vm來測試<br>
用windows vm 再裝幾個有已知漏洞的作為基礎測試<br>
再用這個部分來製作專題的報告<br>
...
各個段落採用RAG或finetone過的模型，來進行生成，也有可能是claude+RAG<br>
目前思考的結構:<br>
拍子分析    => 段落生成 => 段落組合 => 評斷好壞 =>人類評分<br>
歌曲分段+曲風分析  ^
